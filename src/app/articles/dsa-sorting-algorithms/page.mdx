...
export const article = {
  ...
  description:
    'Understanding Sorting Algorithms is a fundamental concept in computer science. It helps us analyze the performance of algorithms and data structures.',
}
...
|_   _|____  _| |_ _ __ ___   ___  _ __
  ...
  "#;
    ...
    let selected_pokemon = utils::select_pokemon();

    let fight_text = "Please select the pokemon you want to fight: ";
    println!("{}", fight_text.bright_cyan());
    let selected_pokemon_to_fight = utils::select_pokemon();
